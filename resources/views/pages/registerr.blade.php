                        ...
                        <form method="POST" action="{{ route('registerr') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="group">
                                    ...
                                    <input id="voterPrenom" type="text"
                                        class="form-control @error('voterPrenom') is-invalid @enderror"
                                        name="voterPrenom" value="{{ old('voterPrenom') }}" required autocomplete="name"
                                        autofocus>
                            ...
                            <div class="group">
                                ...
                                <input id="voterNom" type="text"
                                    class="form-control @error('name') is-invalid @enderror" name="voterNom"
                                    value="{{ old('voterNom') }}" required autocomplete="name" autofocus>
                            ...
                            <div class="group">
                                ...
                                <input id="voterCIN" type="text"
                                    class="form-control @error('voterCIN') is-invalid @enderror" name="voterCIN"
                                    value="{{ old('voterCIN') }}" required autocomplete="name" autofocus>
