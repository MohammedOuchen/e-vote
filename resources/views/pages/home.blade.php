...
<div class="buttons">
    <button class="button buttonHome"> Voter
    ...
    <button class="button buttonHome">candidater
...
<div class="divs">
    ...
    <div class="card text-dark bg-light mb-3 ">
        <div id="blueone" class="card-body text-center">
            ...
            <hr>
            <p class="card-text">Tous les électeurs français sont libres de se porter candidat à l’élection. </p>
            <button class="button buttonC "> Candidater </button>
        </div>
    </div>
    ...
    <div class="card border-danger mb-3">
        <div class="card-body text-center">
            ...
            <hr>
            <p class="card-text">Les résultats nationaux du premier tour de l'élection présidentielle française de 2022
                seront dévoilés le dimanche 11 février à partir de 09h.</p>
            <button class="button buttonV "> Voir les résultats</button>
        </div>
    </div>
    ...
    <div class="card text-dark bg-light mb-3">
        <div id="redone" class="card-body text-center">
            ...
            <button class="button buttonV "> Voter </button>
        </div>
    </div>
</div>
