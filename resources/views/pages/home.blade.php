...
< @section('content') <img class="mainImg" src="{{ asset('Pictures/HomePagePicture.png') }}" width="409" height="451">
    <div class="buttons">
        <a href="{{ route('login') }}" class="button buttonHome"> Voter
        ...
        <a href="{{ route('register') }}" class="button buttonHome">candidater
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <a href="{{ route('register') }}" class="InscButton">S'inscrire maintenant !</a>
    ...
    <div class="divs">
        ...
        <div class="card text-dark bg-light mb-3 ">
            <div id="blueone" class="card-body text-center">
                ...
                <a href="{{ route('register') }}" class="button buttonC "> Candidater </a>
            </div>
        </div>
        ...
        <div class="card border-danger mb-3">
            <div class="card-body text-center">
                ...
                <a href="{{ route('login') }}" class="button buttonV "> Voir les résultats</a>
            </div>
        </div>
        ...
        <div class="card text-dark bg-light mb-3">
            <div id="redone" class="card-body text-center">
                ...
                <a href="{{ route('login') }}" class="button buttonV "> Voter </a>
            </div>
        </div>
    </div>
